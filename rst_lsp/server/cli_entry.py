"""CLI entry point, to start language server.
...
def add_arguments(parser):
    parser.description = "RST Language Server"
    ...
    parser.add_argument(
        "--port",
        type=int,
        default=2088,  # picked to be one greater than pyls
...
def main():
    ...
    if args.tcp:
        start_tcp_lang_server(
            args.host, args.port, args.check_parent_process, RstLanguageServer
        )
    else:
